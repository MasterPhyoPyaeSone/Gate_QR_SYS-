<style>
    ...
    .card-front img.photo {
        ...
        margin-bottom: 20px;
        /* fallback bg */
        border: 2px solid rgb(59, 197, 252);
        /* gold border */
...
<x-navbar type="teacher" style="display: flex">
    <div class="dd">
                ...
                <div class="card-side card-front" id="front-card">
                    ...
                    <div id="student-info">
                        ...
                        <div class="forname">
                         ...
                         @else
                        <div class="fornamee">
                            {{-- <p style="text-transform: uppercase;font-weight: 700;font-size:10px;margin-right:6px;">Daw </p> --}}
                            <p id="card-name" style="text-transform: uppercase;font-weight: 700;font-size:10px"></p>
                        </div>
                        @endif
        ...
        <div>
            ...
            <a href="/teachers/{{$user->id}}/send_email_teacher"><button class="btn">Send with Email</button></a>
        </div>
    </div>
    ...
    <script>
        const studentData = {
            ...
            , name: '{{$user->name}}'
            , roll: '{{$user->teacher_id}}'
            , major: '{{$user->position}}'
            , year: '{{$user->department}}'
        };
