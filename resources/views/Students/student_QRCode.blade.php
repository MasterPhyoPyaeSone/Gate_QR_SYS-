...
<x-navbar type="student" style="display: flex">
    <div class="dd">
            ...
            <div class="card" id="student-card">
                ...
                <div class="card-side card-front" id="front-card">
                    ...
                    <div id="student-info">
                        ...
                        @if ($user->gender === 'male')
                        <div class="forname">
                            <p style="text-transform: uppercase;font-weight: 700;font-size:10px;margin-right:6px;">Mg</p>
                            <p id="card-name" style="text-transform: uppercase;font-weight: 700;font-size:10px"></p>

                        </div>
                         @else
                        <div class="fornamee">
                            <p style="text-transform: uppercase;font-weight: 700;font-size:10px;margin-right:6px;">Ma </p>
                            <p id="card-name" style="text-transform: uppercase;font-weight: 700;font-size:10px"></p>
                        </div>
                        @endif

                        <p id="card-roll" style="color: rgb(12, 176, 252);font-weight: 500;"></p>
                ...
                <!-- Back -->
                <div class="card-side card-back" id="back-card">
        ...
        <div>
            ...
            <a href="/students/{{$user->id}}/send_email_student"><button class="btn">Send with Email</button></a>
        </div>
    </div>
    ...
    <script>
        ...
        async function downloadImages() {
            ...
            frontLink.download = '{{$user->name}}(front).png';
            frontLink.click();
            ...
            backLink.download = '{{$user->name}}(back).png';
            backLink.click();
        }
