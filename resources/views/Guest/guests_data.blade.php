    ...
    <div class="max-w-7xl mx-auto py-8">
        ...
        <div class="mb-8" style="margin-top: 80px">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bol" style="color: #7380ec;font-weight:700">Guests Data</h1>
        ...
        <main>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6 animate-fade-in" style="animation-delay: 0.3s;">
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4">
                    ...
                    <div class="mt-4 flex gap-4 justify-end">
                        <a href="/guest_entryData">
                            <button type="button" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-200 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                                <!-- <i class="fas fa-filter"></i> -->
                                <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M360-440 129-735q-5-6-7-12.5t-2-12.5q0-16 11.5-28t28.5-12h560q17 0 28.5 12t11.5 28q0 6-2 12.5t-7 12.5L520-440v240q0 17-11.5 28.5T480-160h-80q-17 0-28.5-11.5T360-200v-240Zm400 240-56-56 63-64H600v-80h167l-63-64 56-56 160 160-160 160ZM440-468l198-252H242l198 252Z"/></svg>
                                <span style="color: aliceblue;">Entry Data</span>
                            </button>
                        </a>
                ...
                {{-- <div class="flex items-center space-x-2">
                        ...
                        <input type="date" id="date" class="border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div> --}}
                ...
                {{-- <div class="mt-4 flex gap-4 justify-end">
                    <a href="/guest_entryData">
                        <button type="button" class="px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition duration-200 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-green-500">
                            <!-- <i class="fas fa-filter"></i> -->
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF"><path d="M360-440 129-735q-5-6-7-12.5t-2-12.5q0-16 11.5-28t28.5-12h560q17 0 28.5 12t11.5 28q0 6-2 12.5t-7 12.5L520-440v240q0 17-11.5 28.5T480-160h-80q-17 0-28.5-11.5T360-200v-240Zm400 240-56-56 63-64H600v-80h167l-63-64 56-56 160 160-160 160ZM440-468l198-252H242l198 252Z"/></svg>
                            <span style="color: aliceblue;">Entry Data</span>
                        </button>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="color: #4299e1;font-size: 15px;font-weight: 500;padding-left: 85px;">
                                    Email
                                </th>
                                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" style="color: #4299e1;font-size: 15px;font-weight: 500;padding-left: 45px;">
                                    State
                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <a href="/guests/{{$std->id}}/guest_QRcode"><div class="text-sm font-medium text-gray-900">{{ $std->name }}</div></a>

                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900" style="padding-left: 15px;">{{ $std->purpose }}</div> <!-- Assuming you have a guest_id property -->
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap pl-10">
                                    <span class="text-sm text-gray-900">
                                        {{ $std->email }} <!-- Assuming you have a phone_number property -->
                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap pl-10">
                                    ...
                                    {{-- @dd($std->used) --}}
                                    @if($std->used == '0')
                                      <span class="px-2 inline-flex text-xs  leading-5 font-semibold rounded-full mx-4 bg-green-100 text-green-800">In</span>

                                    @endif
                                    @if($std->used == '1')
                                    <span class="px-2 inline-flex text-xs  leading-5 font-semibold rounded-full mx-4 bg-red-500 text-white">Out</span>
        ...
        <div class="mt-6 flex justify-end">
            <button class="px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-200 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <a href="/guest_register"> <span style="color: #f1f1f1;">Add New Guest</span></a>
            </button>
        </div>
    </div>
</x-navbar>
