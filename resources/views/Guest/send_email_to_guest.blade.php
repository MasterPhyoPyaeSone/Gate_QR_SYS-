            ...
            <form id="mailForm" class=" space-y-3" action="{{ route('mail.send') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-3">
                    ...
                    <label class="block">
                        ...
                        <textarea name="message" style="font-weight: 700; " rows="3" class="mt-1 w-full rounded-xl border p-2" placeholder="Write a short note">Don't share this QRCode and this QRCode will expires after 24 hours</textarea>
                ...
                <div class="flex items-center gap-6" style="margin-top: 25px">
                    ...
                    <a href="/guestsDetail"><button type="button" id="cancelBtn" class="px-4 py-2 rounded-xl border">Cancel</button></a>
                </div>
            </form>
