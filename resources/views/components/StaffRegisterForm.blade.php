    ...
    <x-navbar type='staff'>
        ...
        <div class="max-w-4xl mx-auto py-8">
            ...
            <form action="{{$type==='create' ? '/staff_register' : '/staffs/'.$staff->id.'/update'}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-container p-6 md:p-10">
                    <div class="flex flex-col md:flex-row gap-8">
                        ...
                        <div class="w-full md:w-1/3">
                            <div class="photo-upload rounded-lg p-6 flex flex-col items-center justify-center h-full">
                                <div class="mb-4 w-40 h-40 rounded-full overflow-hidden bg-gray-100 flex items-center justify-center">
                                    ...
                                    <img id="preview-img" src="{{ $type == 'update' && $staff->image ? asset('storage/'.$staff->image) : 'https://media.istockphoto.com/id/1208175274/vector/avatar-vector-icon-simple-element-illustrationavatar-vector-icon-material-concept-vector.jpg?s=612x612&w=0&k=20&c=t4aK_TKnYaGQcPAC5Zyh46qqAtuoPcb-mjtQax3_9Xc='}}">
                                </div>
                        ...
                        <div class="w-full md:w-2/3">
                            ...
                            <h1 class="text-3xl font-bold  mb-1  text-gradient-to-r from-indigo-500 to-purple-600">{{$type== 'update' ? "Staff Information" : "Staff Registration"}}</h1>
                            <p class="text-gray-600 mb-6">Please fill out all the required information</p>

                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Roll Number -->
                                <div class="mb-4">
                                    <lable for="name" class="block font-bold text-gray-700 mb-1">Staff ID *</label>
                                        <input type="text" value="{{$type == 'update' ? $staff->staff_id : ''}}" name="staff_id" id="roll-number" required class="form-input font-light w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                </div>
                                <!-- Name -->
                                <div class="mb-4">
                                    <label for="name" class="block font-bold text-gray-700 mb-1">Full Name *</label>
                                    <input type="text" value="{{ $type == 'update' ? $staff->name : ''}}" name="name" id="name" required class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <select id="year" name="position" required class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                        ...
                                        <option value="General Staff" {{$type == 'update' ? $staff->position == 'General Staff' ? 'selected' : '' : '' }}>General Staff </option>
                                        <option value="Office Staff" {{$type == 'update' ? $staff->position == 'Office Staff' ? 'selected' : '' :''}}>Office Staff </option>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="tel" value="{{$type == 'update' ? $staff->ph_no :''}}" name="ph_no" id="phone" required class="form-input flex-1 rounded-none rounded-r-md px-4 py-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500" pattern="[0-9]{10}">
                                    </div>
                                </div>
                            </div>
                            <!-- Gender -->
                            <div class="mb-4 mt-6">
                                ...
                                <div class="flex space-x-12">
                                    <label class="inline-flex items-center">
                                        <input type="radio" {{$type == 'update' ? $staff->gender == 'male' ? 'checked' : '' :''}} name="gender" value="male" required class="form-radio h-4 w-4 text-indigo-600">
                                        <span class="ml-2 text-gray-700">Male</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" {{$type == 'update' ? $staff->gender == 'female' ? 'checked' : '' :''}} name="gender" value="female" class="form-radio h-4 w-4 text-indigo-600">
                            ...
                            <div class="mb-4 mt-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="email" value="{{$type == 'update' ? $staff->email : ''}}" name="email" id="email" required class="form-input w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            </div>
